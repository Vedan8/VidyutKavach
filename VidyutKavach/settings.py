"""
Django settings for VidyutKavach project.
...
SECRET_KEY = 'django-insecure-n&xfbc+!)+j05ddf7^e#8b*6zepxmxz4nb$o1+70+wi(p8m9dy'
...
ROOT_URLCONF = 'VidyutKavach.urls'
...
WSGI_APPLICATION = 'VidyutKavach.wsgi.application'
